...
export const ComparisonSection = () => {
  ...
  const comparisons = [{
    ...
    advantages: ["Šetri čas - nestrácaj čas cestovaním", "Cvič z domu - bez hanby, stresu, porovnávania", "Využi časovú flexibilitu, ktorú prispôsobíš rodinnému rozvrhu", "Cenovo efektívne - žiadne mesačné vysoké poplatky", "Priateľské k mamičkám - cvič s deťmi doma"]
  }, {
    number: "2",
