...
export const ComparisonSection = () => {
  ...
  const comparisons = [{
    ...
    advantages: ["Šetri čas - nestrácaj čas cestovaním", "Cvič z domu - bez hanby, stresu, porovnávania", "Flexibilita - prispôsob si svoje cvičenie, aby ti zapadlo do rodinného rozvrhu", "Cenovo efektívne - žiadne mesačné vysoké poplatky", "Priateľské k mamičkám - cvič s deťmi doma"]
  }, {
    number: "2",
