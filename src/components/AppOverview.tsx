...
},
{
  ...
  features: ["Uzavretá online skupina žien", "Live Q&A s Gabi", "Vzájomná podpora a motivácia"],
...
},
{
  ...
  features: ["Doplnkové workouty, strečingy", "Doplnkové články, meditácie, recepty", "Bonusový obsah a zľavy u našich partnerov"],
...
},
{
  ...
  features: ["Sleduj svoj progres – kroky, zdravé jedlá, cvičenie...", "Reflektuj. Čo sa ti dnes podarilo a čo môžeš zajtra spraviť lepšie", "Dostávaj dennú motiváciu, ktorá ťa nakopne v dňoch, kedy to potrebuješ"],
    ...
    <section className="py-20 md:py-28 px-4 md:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          <Badge variant="secondary" className="mb-4 px-4 py-2">Čo ti NeoMe ponúka?
          </Badge>
