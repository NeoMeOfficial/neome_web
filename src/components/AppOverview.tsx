...
},
{
  ...
  features: ["Sleduj svoj progres – kroky, zdravé jedlá, cvičenie...", "Buduj pozitívny self-talk. Reflektuj a zapisuj. Čo sa ti dnes podarilo a čo môžeš zajtra spraviť lepšie", "Dostávaj dennú motiváciu, ktorá ťa nakopne v dňoch, kedy to potrebuješ"],
