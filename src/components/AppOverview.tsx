...
},
{
  ...
  features: ["Sleduj svoj progres – kroky, zdravé jedlá, cvičenie...", "Reflektuj, čo sa ti dnes ne/podarilo a čo môžeš zajtra spraviť lepšie", "Dostávaj dennú motiváciu, ktorá ťa nakopne v dňoch, kedy to potrebuješ"],
