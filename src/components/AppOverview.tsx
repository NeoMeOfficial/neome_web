...
},
{
  ...
  features: ["Presné trackovanie tvojho cyklu", "Predikovanie nasledujúcej menštruácie a plodných dní", "Tipy ako zmierniť nežiaduce symptómy, ako cvičiť, jesť a podporiť telo"],
