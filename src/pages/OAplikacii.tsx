          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-12rem)]">
            ...
            duration: 0.8
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-light mb-6 leading-[1.1]">
                Pomôžeme ti začať tam, kde si. <span className="gradient-text font-normal">Začni</span><br /><span className="gradient-text font-normal">Každý deň aspoň 15-min pre seba!</span>
              </h1>
