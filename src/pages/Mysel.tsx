          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-2xl text-muted-foreground font-light mb-8">
                Denné meditácie a dychové cvičenia pre mentálny pokoj
              </p>
              <p className="text-lg leading-relaxed mb-8">
                Krátke meditácie a dychové cvičenia na okamžité upokojenie mysle – aj keď máš len 3 minúty. Každý deň ti pripomíname, že si dosť presne taká, aká si. Získaj nástroje, ktoré ti pomôžu zvládnuť stres a vrátiť sa do svojho centra.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 bg-white border-border/10">
              ...
              <p className="text-muted-foreground">
                Aj 3 minúty denne môžu urobiť veľký rozdiel. Nájdi si čas na pokoj mysle.
              </p>
            </Card>
            <Card className="p-8 bg-white border-border/10">
              <CheckCircle size={48} weight="fill" className="text-primary mb-4" />
              <h3 className="text-xl font-medium mb-3">Vedené praktiky</h3>
              <p className="text-muted-foreground">
                Jednoduché vedené meditácie a dychové cvičenia pre každý deň.
              </p>
            </Card>
            <Card className="p-8 bg-white border-border/10">
              <CheckCircle size={48} weight="fill" className="text-primary mb-4" />
              <h3 className="text-xl font-medium mb-3">Zvládanie stresu</h3>
              <p className="text-muted-foreground">
                Nástroje, ktoré ti pomôžu zvládnuť stres a vrátiť sa do svojho centra.
              </p>
            </Card>
          </div>
        </div>
