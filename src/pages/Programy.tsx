...
const Programy = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div 
        className="fixed inset-0 pointer-events-none opacity-[0.7] -z-10"
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='4.5' numOctaves='6' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' fill='%23C4A77D'/%3E%3C/svg%3E")`,
